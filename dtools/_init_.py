...
print(f"City distribution has sample mean {mean}" +
      f"and sample standard deviation of {std:7.2f}.")
...
# Make sure that you understand how this works:
...
print(f"Average availability over 365 days is {np.mean(ds2['availability_365']):.2f}")
...
get_ipython().system('jupyter nbconvert --ClearOutputPreprocessor.enabled=True     --to python --output=dtools/_init_.py     Practical-04-Objects.ipynb')
